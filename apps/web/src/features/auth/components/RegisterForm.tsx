...
import { UtensilsCrossed, User, Mail, Lock, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-stone-50 p-6">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-stone-800">MealMind</h1>
          <p className="text-stone-600 mt-2">Tạo tài khoản mới</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Name */}
          <div>
            <label className="block text-sm font-medium text-stone-700 mb-2">Họ tên</label>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm"><span className="px-4 bg-stone-50 text-stone-500">hoặc</span></div>
          </div>
