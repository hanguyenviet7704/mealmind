...
import { Link as LinkIcon, ImageIcon, Globe, Clock, Flame, Tag, ArrowLeft, Heart, BookmarkPlus, ChefHat } from 'lucide-react';
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between">
            ...
            <div className="mt-4 md:mt-0 flex gap-3">
              <Button variant="outline" className="border-stone-200 text-stone-700" onClick={() => router.back()}>
                Hủy bỏ
              </Button>
                  ...
                  <div className="p-4 bg-orange-50 rounded-xl border border-orange-100 flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-orange-700/80 mb-3">
                        Dán liên kết bài viết, video (YouTube, TikTok), hệ thống sẽ tự động điền các thông tin cơ bản.
                      </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      ...
                      <div className="space-y-2">
                        <Label className="text-stone-700 font-medium">Nguồn sưu tầm</Label>
                      ...
                      <div className="space-y-2">
                        <Label className="text-stone-700 font-medium">Phân loại món</Label>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-800/80 leading-relaxed">
                  Cài đặt <span className="font-medium underline cursor-pointer hover:text-blue-900">Tiện ích mở rộng MealMind</span> để thêm món ăn từ bất kỳ trang web nào chỉ với một cú click chuột!
                </p>
              </div>
            </div>
          </div>
